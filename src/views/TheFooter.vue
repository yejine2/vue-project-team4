    ...
    <div class="inner">
      <div class="service-area">
        <div class="footer-menu">
          <div class="menu-box">
            <strong class="menu-title">이용안내</strong>
            <ul class="menu-list">
              <li class="menu-item">
                <router-link
                  to="#"
          ...
          <div
            ...
            <strong class="menu-title">고객지원</strong>
            <ul class="menu-list">
              <li class="menu-item">
                <router-link
                  to="#"
        ...
        <div class="customer-service">
          <strong class="service-title">고객센터
            <a
              href="tel:1588-7813"
              class="service-tel">1588-7813</a>
          </strong>
          ...
          <div class="service-btn-box">
            <a href="#"><button class="service-btn">자주 묻는 질문</button></a>
          </div>
        </div>
      </div>
      <div class="corporation_area">
        ...
        <div class="footer-sns">
          ...
          <a href="#"><img
            ...
            alt="facebook" /></a>
          <a href="#"><img
            src="/assets/home/footer/kakaotalk.png"
            alt="kakaotalk" /></a>
        </div>
        <div class="business-info">
          <div class="info-list">
            <dl class="info-item">
              <dt class="business-title">
                크림 주식회사 · 대표
              </dt>
      ...
      <div class="escrow-area">
        <img
          ...
          src="/assets/home/footer/escrow.png"
          alt="escrow" />
      ...
      <div class="notice-area">
        <p class="notice">
          해당 사이트는 크림 주식회사 사이트를 참조하여 학습목적으로 만들었습니다.
        </p>
        <p class="copyright">
          © KREAM Corp.
        </p>
